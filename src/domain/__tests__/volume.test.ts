// Tests for physio load computation.
import { describe, expect, it } from "vitest";
import { dailyPhysioLoad, exerciseVolume } from "../load";
...
describe("dailyPhysioLoad", () => {
  it("sums entries and returns 0 for a rest day", () => {
    ...
    expect(dailyPhysioLoad(day)).toBe(27);
    expect(dailyPhysioLoad({ exercises: [] })).toBe(0);
  });
});
